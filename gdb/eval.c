...
struct value *
evaluate_subexp (struct type *expect_type, struct expression *exp, /*sylee test*/
...
struct value *
evaluate_subexp_standard (struct type *expect_type, /*sylee test*/
			  struct expression *exp, int *pos,
			  enum noside noside)
{
  enum exp_opcode op;
  ...
  switch (op)
    ...
    case BINOP_ASSIGN: /* sylee test : print set */
      arg1 = evaluate_subexp (NULL_TYPE, exp, pos, noside);
