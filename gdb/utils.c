...
phex_nz (ULONGEST l, int sizeof_l)
{
 ...
 /*
    printf("[high : %lu/ %lx]", high, high);
    printf("[long : %lu/ %lu]\n", (unsigned long) l, (unsigned long) (l & 0xffffffff));
    printf("[long : %lx/ %lx/ %08lx]\n", (unsigned long) l, (unsigned long) (l & 0xffffffff), (unsigned long) (l & 0xffffffff));
 */
